...
class AzureVoiceoverSolutionScene(VoiceoverScene):
    def __init__(self, **kwargs):
        ...
        self.solution_json = json.loads(r'''{"steps": [{"stepNumber": 0, "description": "Presentamos el problema matem\u00e1tico original que vamos a resolver.", "formula": "48a^2 + 16a^4 - 18a - 62a^3 + 5 + 2a^2 - 6a"}, {"stepNumber": 1, "description": "Reordenamos los t\u00e9rminos para agruparlos por potencias de 'a'.", "formula": "16a^4 - 62a^3 + \\hl{48a^2 + 2a^2} - \\hl{18a - 6a} + 5"}, {"stepNumber": 2, "description": "Sumamos los coeficientes de los t\u00e9rminos con 'a al cuadrado'.", "formula": "16a^4 - 62a^3 + \\hl{(48 + 2)a^2} - 18a - 6a + 5"}, {"stepNumber": 3, "description": "Realizamos la suma de los coeficientes de 'a al cuadrado', obteniendo cincuenta.", "formula": "16a^4 - 62a^3 + 50a^2 - 18a - 6a + 5"}, {"stepNumber": 4, "description": "Sumamos los coeficientes de los t\u00e9rminos con 'a'.", "formula": "16a^4 - 62a^3 + 50a^2 + \\hl{(-18 - 6)a} + 5"}, {"stepNumber": 5, "description": "Realizamos la suma de los coeficientes de 'a', obteniendo menos veinticuatro.", "formula": "16a^4 - 62a^3 + 50a^2 - 24a + 5"}, {"stepNumber": "Final", "description": "La expresi\u00f3n simplificada final es diecis\u00e9is a a la cuarta menos sesenta y dos a al cubo m\u00e1s cincuenta a al cuadrado menos veinticuatro a m\u00e1s cinco.", "formula": "16a^4 - 62a^3 + 50a^2 - 24a + 5"}]}''')
