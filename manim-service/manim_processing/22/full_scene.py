...
class VoiceoverSolutionScene(VoiceoverScene):
    ...
    def construct(self):
        ...
        self.set_speech_service(OpenAIService(api_key=openai_api_key_from_env, voice='nova', transcription_model=None))
