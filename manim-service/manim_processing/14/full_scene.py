...
class AzureVoiceoverSolutionScene(VoiceoverScene):
    def __init__(self, **kwargs):
        ...
        self.solution_json = json.loads(r'''{"steps": [{"stepNumber": 0, "description": "El problema a resolver es la suma de dos fracciones.", "formula": "\\frac{19}{8} + \\frac{57}{8}"}, {"stepNumber": 1, "description": "Identificamos que ambas fracciones tienen el mismo denominador.", "formula": "\\frac{19}{\\hl{8}} + \\frac{57}{\\hl{8}}"}, {"stepNumber": 2, "description": "Por lo tanto, podemos sumar directamente los numeradores y mantener el denominador com\u00fan.", "formula": "\\frac{\\hl{19 + 57}}{8}"}, {"stepNumber": 3, "description": "Realizamos la suma de los numeradores, obteniendo setenta y seis.", "formula": "\\frac{\\hl{76}}{8}"}, {"stepNumber": 4, "description": "Ahora, simplificamos la fracci\u00f3n dividiendo el numerador y el denominador por su m\u00e1ximo com\u00fan divisor, que es cuatro.", "formula": "\\frac{\\hl{76} \\div \\hl{4}}{\\hl{8} \\div \\hl{4}}"}, {"stepNumber": 5, "description": "Realizamos las divisiones para obtener la fracci\u00f3n simplificada.", "formula": "\\frac{\\hl{19}}{\\hl{2}}"}, {"stepNumber": "Final", "description": "La respuesta final a la operaci\u00f3n es diecinueve medios.", "formula": "\\frac{19}{2}"}]}''')
