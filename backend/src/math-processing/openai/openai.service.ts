...
export class OpenaiService {
  ...
  async generateStepByStepSolution(
    ...
    try {
      // const userPrompt = `Resuelve el siguiente problema matemático paso a paso.
      // El problema es: ${extractedMathLatex}.
      // Contexto: País: ${country || 'General'}, Etapa: ${stage || 'General'}, Nivel: ${subdivision || 'General'}.

      // Tu respuesta DEBE ser un objeto JSON válido con la siguiente estructura:
      // {
      //   "steps": [
      //     { "stepNumber": 0, "description": "Problema a resolver:", "formula": "${extractedMathLatex.replace(/"/g, '\\"')}" },
      //     { "stepNumber": 1, "description": "Explicación del primer paso de la solución...", "formula": "LaTeX del paso 1" },
      //     { "stepNumber": 2, "description": "Explicación del segundo paso...", "formula": "LaTeX del paso 2" },
      //     ...
      //     { "stepNumber": "Final", "description": "Respuesta Final:", "formula": "LaTeX de la respuesta final" }
      //   ]
      // }

      // Asegúrate de que:
      // 1. El primer elemento del array "steps" (con stepNumber 0) SIEMPRE contenga el problema original.
      // 2. El último elemento del array "steps" contenga la respuesta final.
