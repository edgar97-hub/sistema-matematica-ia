...
], OrderEntity.prototype, "creditTransactionId", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => credit_transaction_entity_1.CreditTransactionEntity, (creditTransaction) => creditTransaction.orders),
    (0, typeorm_1.JoinColumn)({ name: 'creditTransaction_id' }),
    __metadata("design:type", credit_transaction_entity_1.CreditTransactionEntity)
], OrderEntity.prototype, "creditTransaction", void 0);
__decorate([
