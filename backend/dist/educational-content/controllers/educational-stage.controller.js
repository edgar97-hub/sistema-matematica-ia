...
let EducationalStageController = class EducationalStageController {
    ...
    findActiveStagesByCountryName(countryName) {
...
__decorate([
    (0, common_1.Get)('by-id-country/:countryId/pwa-list'),
...
__decorate([
    (0, common_1.Get)('by-name-country/:countryName/pwa-list'),
    __param(0, (0, common_1.Param)('countryName')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], EducationalStageController.prototype, "findActiveStagesByCountryName", null);
__decorate([
    (0, common_1.Get)(':id'),
