...
let SystemConfigurationService = class SystemConfigurationService {
    ...
    constructor(systemConfigurationRepository) {
    ...
    async updateConfiguration(updateConfigDto) {
...
exports.SystemConfigurationService = SystemConfigurationService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(system_configuration_entity_1.SystemConfigurationEntity)),
