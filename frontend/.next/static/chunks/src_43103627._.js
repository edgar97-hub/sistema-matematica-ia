...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$credit$2d$transaction$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/services/credit-transaction.service.ts [app-client] (ecmascript)"); // Ajusta ruta
...
function SuccessContent() {
    ...
    const { data: purchaseStatus, isLoading, isError, error, isSuccess, refetch, status: queryStatus } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        queryKey: [
            "purchase-status",
            sessionId
        ],
        queryFn: {
            "SuccessContent.useQuery": async ()=>{
                ...
                return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$credit$2d$transaction$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["creditTransactionService"].getPurchaseStatus(sessionId);
            }
        }["SuccessContent.useQuery"],
        enabled: !!sessionId && !!token,
        refetchInterval: {
            "SuccessContent.useQuery": (query)=>{
                const currentData = query.state.data;
                if (currentData?.status === "pending_webhook" || query.state.status === "error" && query.state.fetchFailureCount < 3) {
                    return 5000;
                }
                return false;
            }
            ...
            if (isSuccess && purchaseStatus) {
                if (showProcessingMessage && purchaseStatus.status === "completed") {
                    ...
                    if (user && purchaseStatus.newBalance !== undefined && token) {
                        setUser({
                            ...user,
                            credits: purchaseStatus.newBalance
                        }, token);
                    }
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SuccessContent.useEffect": ()=>{
            if (isError && error) {
                console.error("useEffect (onError logic) - Purchase Status Error:", error);
                setShowProcessingMessage(false);
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mantine$2f$notifications$2f$esm$2f$notifications$2e$store$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["notifications"].show({
                    title: "Error Verificando Compra",
                    message: error.message || "No se pudo verificar el estado de la compra. Revisa tu dashboard.",
                    color: "red"
                });
            }
        }
...
_s(SuccessContent, "c9ues6XAcooNumeR10dFyvdxsgc=", false, function() {
    return [
...
//# sourceMappingURL=src_43103627._.js.map