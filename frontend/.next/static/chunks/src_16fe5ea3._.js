...
"[project]/src/app/(admin_panel)/admin/educational-content/countries/create/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function CreateCountryPage() {
    ...
    const { mutateAsync: createCountryMutation, isPending } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: {
            "CreateCountryPage.useMutation": async ({ formData, flagFile })=>{
                ...
                return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$country$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["countryService"].createCountry(dataToSubmit);
            }
        }["CreateCountryPage.useMutation"],
        onSuccess: {
            "CreateCountryPage.useMutation": (newCountry)=>{
        ...
        onError: {
            "CreateCountryPage.useMutation": (error)=>{
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mantine$2f$notifications$2f$esm$2f$notifications$2e$store$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["notifications"].show({
...
_s(CreateCountryPage, "mwNXqp4a/UWAVAfmfVjpwgpMubc=", false, function() {
    return [
...
_c = CreateCountryPage;
var _c;
__turbopack_context__.k.register(_c, "CreateCountryPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_16fe5ea3._.js.map