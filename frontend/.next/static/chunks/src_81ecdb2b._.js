...
"[project]/src/app/(admin_panel)/admin/educational-content/stages/create/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/navigation.js [app-client] (ecmascript)"); // De 'next/navigation' para App Router
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$admin$2f$stages$2f$EducationalStageFormComponent$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/admin/stages/EducationalStageFormComponent.tsx [app-client] (ecmascript)"); // Ajusta ruta
...
function CreateEducationalStagePage() {
    ...
    const { data: countries, isLoading: isLoadingCountries, isError: isCountriesError } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: {
            "CreateEducationalStagePage.useQuery": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$country$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["countryService"].getActiveCountriesForPwa()
        }["CreateEducationalStagePage.useQuery"]
    });
    const { mutateAsync: createStageMutation, isPending } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$educational$2d$stage$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["educationalStageService"].createEducationalStage,
        onSuccess: {
            "CreateEducationalStagePage.useMutation": (newStage)=>{
        ...
        }["CreateEducationalStagePage.useMutation"],
        onError: {
            "CreateEducationalStagePage.useMutation": (error)=>{
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mantine$2f$notifications$2f$esm$2f$notifications$2e$store$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["notifications"].show({
...
_s(CreateEducationalStagePage, "78vlFR2WrNlNSzdfc4kKRyDhxI8=", false, function() {
    return [
...
_c = CreateEducationalStagePage;
var _c;
__turbopack_context__.k.register(_c, "CreateEducationalStagePage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_81ecdb2b._.js.map