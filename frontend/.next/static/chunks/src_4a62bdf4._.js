...
"[project]/src/lib/services/credit-package.service.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const creditPackageService = {
    ...
    async getCreditPackages () {
        ...
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$apiClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].get("/credit-packages");
        return response.data;
    },
    async getCreditPackageById (id) {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$apiClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].get(`/credit-packages/${id}`);
        return response.data;
    },
    async createCreditPackage (data) {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$apiClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].post("/credit-packages", data);
        return response.data;
    },
    async updateCreditPackage (id, data) {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$apiClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].patch(`/credit-packages/${id}`, data);
        return response.data;
    },
    async deleteCreditPackage (id) {
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$apiClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].delete(`/credit-packages/${id}`);
    },
    async getActiveCreditPackagesForPwa () {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$apiClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].get("/credit-packages/users/active");
        return response.data;
    }
};
...
"[project]/src/app/(pwa_app)/credits/credits-page.module.css [app-client] (css module)": ((__turbopack_context__) => {
...
"[project]/src/app/(pwa_app)/credits/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)"); // No necesitas useEffect aquí si usas React Query para el ciclo de vida
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tabler$2f$icons$2d$react$2f$dist$2f$esm$2f$icons$2f$IconPremiumRights$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__IconPremiumRights$3e$__ = __turbopack_context__.i("[project]/node_modules/@tabler/icons-react/dist/esm/icons/IconPremiumRights.mjs [app-client] (ecmascript) <export default as IconPremiumRights>");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$pwa_app$292f$credits$2f$credits$2d$page$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__ = __turbopack_context__.i("[project]/src/app/(pwa_app)/credits/credits-page.module.css [app-client] (css module)");
;
...
function CreditPackagesPage() {
    ...
    const [isRedirectingToStripeId, setIsRedirectingToStripeId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const { data: packagesData, isLoading: isLoadingPackages, isError: isPackagesError, error: packagesError } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        queryKey: [
            "active-credit-packages-pwa"
        ],
        queryFn: {
            "CreditPackagesPage.useQuery": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$credit$2d$package$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["creditPackageService"].getActiveCreditPackagesForPwa()
        }["CreditPackagesPage.useQuery"],
        enabled: !!user
    });
    const packages = packagesData || [];
    const { mutateAsync: createCheckoutSessionMutation, isPending: isCreatingSession } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: {
            "CreditPackagesPage.useMutation": async (packageId)=>{
                if (!user || !token) throw new Error("Usuario no autenticado.");
                return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$credit$2d$transaction$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["creditTransactionService"].createStripeCheckoutSession(packageId.toString(), token);
            }
        }["CreditPackagesPage.useMutation"],
        onSuccess: {
            "CreditPackagesPage.useMutation": (stripeSession)=>{
        ...
        onError: {
            "CreditPackagesPage.useMutation": (error)=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mantine$2f$core$2f$esm$2f$core$2f$Box$2f$Box$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Box"], {
        p: "lg",
        className: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$pwa_app$292f$credits$2f$credits$2d$page$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].creditsPageContainer,
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mantine$2f$core$2f$esm$2f$components$2f$Title$2f$Title$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Title"], {
                order: 2,
                className: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$pwa_app$292f$credits$2f$credits$2d$page$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].pageTitle,
                mb: "xl",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tabler$2f$icons$2d$react$2f$dist$2f$esm$2f$icons$2f$IconPremiumRights$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__IconPremiumRights$3e$__["IconPremiumRights"], {
                        size: 32,
                        style: {
                            marginRight: "12px",
            ...
            packages.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mantine$2f$core$2f$esm$2f$components$2f$SimpleGrid$2f$SimpleGrid$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SimpleGrid"], {
                ...
                children: packages.map((pkg)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mantine$2f$core$2f$esm$2f$components$2f$Paper$2f$Paper$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Paper"], {
                        ...
                        p: "lg",
                        radius: "md",
                        className: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$pwa_app$292f$credits$2f$credits$2d$page$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].packageCard,
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mantine$2f$core$2f$esm$2f$components$2f$Group$2f$Group$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Group"], {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mantine$2f$core$2f$esm$2f$components$2f$Title$2f$Title$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Title"], {
                                        order: 3,
                                        className: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$pwa_app$292f$credits$2f$credits$2d$page$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].packageName,
                                        children: pkg.name
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/(pwa_app)/credits/page.tsx",
                                        lineNumber: 164,
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mantine$2f$core$2f$esm$2f$components$2f$Text$2f$Text$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Text"], {
                                ...
                                mt: "xs",
                                mb: "md",
                                className: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$pwa_app$292f$credits$2f$credits$2d$page$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].packageDescription,
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mantine$2f$core$2f$esm$2f$components$2f$Text$2f$Text$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Text"], {
                                size: "xl",
                                fw: 700,
                                className: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$pwa_app$292f$credits$2f$credits$2d$page$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].packagePrice,
                                mb: "lg",
                                children: [
                                    "S/ ",
                                    " ",
...
_s(CreditPackagesPage, "Hw+Ne7WD+TwGGqVMVnj96zreo68=", false, function() {
    return [
...
_c = CreditPackagesPage;
var _c;
__turbopack_context__.k.register(_c, "CreditPackagesPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_4a62bdf4._.js.map