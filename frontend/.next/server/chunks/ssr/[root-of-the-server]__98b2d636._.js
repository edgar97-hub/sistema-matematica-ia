...
"[project]/src/app/(admin_panel)/admin/educational-content/subdivisions/create/page.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/navigation.js [app-ssr] (ecmascript)"); // Importar useSearchParams
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$educational$2d$stage$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/services/educational-stage.service.ts [app-ssr] (ecmascript)"); // Para obtener etapas
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$country$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/services/country.service.ts [app-ssr] (ecmascript)"); // Para obtener países
"use client";
;
;
;
...
function CreateEducationalSubdivisionPage() {
    ...
    const searchParams = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useSearchParams"])(); // Para leer query params
    ...
    const [selectedCountryId, setSelectedCountryId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(searchParams.get("countryId") || null);
    const [selectedStageIdForForm, setSelectedStageIdForForm] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(searchParams.get("stageId") || null);
    ...
    const { data: stages, isLoading: isLoadingStages } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: ()=>selectedCountryId ? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$educational$2d$stage$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["educationalStageService"].getEducationalStagesForPwa(selectedCountryId) // Asume que getEducationalStages puede devolver array simple
             : Promise.resolve([]),
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (stages && selectedStageIdForForm) {
            const isValidStage = (Array.isArray(stages) ? stages : stages || []).some((s)=>s.id.toString() === selectedStageIdForForm);
            if (!isValidStage) {
    ...
    const { mutateAsync: createSubdivisionMutation, isPending } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$educational$2d$subdivision$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["educationalSubdivisionService"].createEducationalSubdivision,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__98b2d636._.js.map