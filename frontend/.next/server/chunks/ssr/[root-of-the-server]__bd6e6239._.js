...
"[project]/src/app/(admin_panel)/admin/educational-content/countries/edit/[id]/page.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$admin$2f$countries$2f$CountryFormComponent$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/admin/countries/CountryFormComponent.tsx [app-ssr] (ecmascript)");
"use client";
;
;
;
...
function EditCountryPage() {
    ...
    const { data: currentCountry, isLoading: isLoadingCountry, isError, error } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useQuery"])({
        queryKey: [
            "country",
            countryId
        ],
        queryFn: ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$country$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["countryService"].getCountryById(countryId),
        enabled: !!countryId
    });
    const { mutateAsync: updateCountryMutation, isPending } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: async ({ formData, flagFile })=>{
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$country$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["countryService"].updateCountry(countryId, dataToUpdate);
        },
...
//# sourceMappingURL=%5Broot-of-the-server%5D__bd6e6239._.js.map